...
import { asMediaInsert, isImageFile, isVideoFile } from "@/utils/supabaseHelpers";
...
type MediaFormValues = z.infer<typeof postSchema> & {
  media?: File;
};
...
export function MediaUploader({ userId, familyId, onSuccess, onCancel }: MediaUploaderProps) {
